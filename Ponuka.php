        ...
        <div class="container-fluid ponuka-menu">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="1" > <div class="edit"><a href="Ponuka.php?edit_menu_item=<?php echo $menuItem['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-brush" viewBox="0 0 16 16">
                ...
                <tr>
                    ...
                    <td colspan="1" > <div class="delete" > <a href="Ponuka.php?delete_menu_item=<?php echo $menuItem['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
