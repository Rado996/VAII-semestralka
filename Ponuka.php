                ...
                <tr>
                    ...
                    <td colspan="1" >
                        <?php if(isset($_SESSION['userName'])){
                            if($_SESSION['userName']== "Admin"){
                                ?>
                                    <div class="edit"><a class="editItembtn" data-item="menu" data-itid="<?php echo $menuItem['id']; ?>" id="editMenuItem" ><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-brush" viewBox="0 0 16 16">
                ...
                <tr>
                    ...
                    <td colspan="1" >
                        <?php if(isset($_SESSION['userName'])){
                            if($_SESSION['userName']== "Admin"){
                                ?>
                                    <div class="delete" > <a class="deleteItembtn" data-item="menu" data-itid="<?php echo $menuItem['id']; ?>" id="deleteMenuItem" > <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
